...
def init(argv):
    ...
    parser.add_option("--test", dest="conll_test", help="Path to CONLL test file or direct text file. See flag istext", metavar="FILE", default="N/A")
    ...
    parser.add_option("--istext",  dest="istext", type="int", default=0)
...
def predict_text(parser,input_file,output_file):
    parser.PredictFromText(input_file,output_file) 

if __name__ == '__main__':
    print "ARGV:" , sys.argv
    options, args =  init(sys.argv)


    #print 'Using external embedding:', options.external_embedding

    if options.predictFlag:
        parser = load_model(options)
        ...
        if (options.istext != 0):
            ...
            print 'Predicting POS tags and parsing dependencies (input,output)',options.conll_test,tespath
            predict_text(parser,options.conll_test,tespath)
        else:
            print "Is text is false"
